# Clear powershell shit
cls

# Variables
$VIMCONF = $env:NVIMCONF
$VIM = 'C:\Users\koteel\scoop\apps\neovim-nightly\current'
$DSK = 'D:\Desktop'
...
New-Alias ll Get-ChildItemExa
Set-Alias dir Get-ChildItemExa -Option AllScope

# Add vim to nvim forwarding
New-Alias vim nvim
...
Set-PoshPrompt -Theme C:/Users/koteel/AppData/Local/oh-my-posh/koteelokTheme.omp.json
